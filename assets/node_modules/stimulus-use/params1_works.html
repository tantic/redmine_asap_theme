  ...
  <script type="module">
    ...
    const debounce = (fn, wait = 200) => {
      ...
      return function() {
        ...
        console.log("args", args[0].params1)

        const callback = () => {
          console.log("args in callback", args[0].params1)
    ...
    function myAction(event) {
      console.log("myAction - params", event.params1)
    }

    const debouncedMyAction = debounce(myAction, 500)

    button.addEventListener("click", (event) => {
      const myEvent = Object.assign(event, { params1: { myId: 321 }})
